...
飞书 CLI 创作者大赛 · 人气赛道第一名。开心，但不飘。

- [x] 10 语言 README 加上获奖标识
- [x] 演示站 Hero 区加入获奖入口
- [x] 轮播、hydration、演示站细节稳定化
- [x] 域名迁移后的仓库清理与 CI 修复

### v1.5.1 — 结项维护版 ✅

把桌面收拾干净，把门牌挂正，然后体面结项。

- [x] 演示站入口统一回到稳定域名
- [x] demo-site 依赖安全补丁与构建检查
- [x] CI 覆盖 Markdown、Python、demo-site
- [x] 移除 Star History 曲线与生成产物
