...
- [ ] 体验模式：说"让我跟奶奶聊天"直接加载示例 Relic，零门槛
- [ ] 主 SKILL.md 流程优化：区分"体验"和"锻造"两条路径
- [ ] examples/README.md：示例目录说明
- [ ] README 补充完整的 IDE / Agent 兼容列表（10+ 平台）

## v1.0.2 — 锻造引导优化

降低锻造门槛，从"你告诉我素材在哪"变成"我来问你，你回答就行"。

- [ ] soul-forge 锻造流程改为对话式引导
- [ ] 按模板类型分别优化提取 prompt（蒸馏猫和蒸馏人的提问方式不同）
- [ ] 迭代蒸馏：第一轮完成后自动识别薄弱维度，主动追问补充
