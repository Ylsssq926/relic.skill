...
<p align="center">
  <a href="https://relic.luelanai.com"><strong>🌐 Live Demo →</strong></a>
</p>
...
### Option 2: Install in one command with npx
...
# Preview whether it would reach out first
...
> Starting with v1.1.2, new Relics generated by `relic_writer.py` come with `proactive_config.json` by default, so you can do a dry-run first and see whether it'd come knocking today.
