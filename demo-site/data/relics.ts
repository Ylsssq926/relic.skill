...
export const exampleRelics: readonly ExampleRelic[] = [
  {
    ...
    coverUrl: "/images/relics/grandma-cover.png",
    avatarUrl: "/images/relics/grandma-avatar.png",
    dialogs: [
      ...
      { user: "今天工作被骂了", relic: "谁还没受过委屈呢,别往心里头死磕。先把饭吃了,睡一觉,明天又是新的一天。" },
    ...
    scenarios: {
      newYear: { user: "奶奶,过年好!", relic: "哎呀,过年好!吃饺子了没?今年包的是韭菜馅的,你爱吃的那种。" },
      birthday: { user: "奶奶,今天我生日", relic: "哎呀,生日快乐!又长大一岁了,要好好照顾自己,顺顺利利的。" },
      random: { user: "奶奶,我突然想你了", relic: "想我啦?那就多跟我说说话。最近怎么样,有没有按时吃饭睡觉?" },
    },
  ...
  },
  {
    ...
    coverUrl: "/images/relics/cat-cover.png",
    avatarUrl: "/images/relics/cat-avatar.png",
    dialogs: [
      ...
      { user: "给你开个罐头", relic: "咪! [耳朵立起来,瞬间精神百倍,甚至提前蹲到固定开饭位等着]" },
      { user: "咪咪,陪我晒太阳", relic: "呼噜。 [跳上窗边,把自己摊成一张热乎乎的小毯子,留出半个位置给你]" },
    ],
    scenarios: {
      newYear: { user: "咪咪,过年啦", relic: "喵呜~ [钻进年货袋里,把红绳叼到你脚边,仿佛自己就是最吉利的新年礼物]" },
      birthday: { user: "咪咪,今天我生日", relic: "喵~ [踩到你腿上坐下,抬头看你,像是把自己郑重其事地送给你]" },
      random: { user: "咪咪,我突然想你了", relic: "喵。 [半夜突然跳到你枕边,用胡子蹭了蹭你的脸,然后安心团成一个橘色小月亮]" },
    },
  ...
  },
  {
    ...
    coverUrl: "/images/relics/team-cover.png",
    avatarUrl: "/images/relics/team-avatar.png",
    dialogs: [
  ...
  },
  {
    ...
    type: "feishu-cli",
    category: "专业数字身份",
    description: "知识不该随人走，把资深专家的专业判断锻造成可对话的数字身份",
    detail: "不是冷冰冰的知识库。是那个会在你评审前主动提醒 Checklist 的前辈，是凌晨三点群里还在手把手教新人的耐心。",
    coverUrl: "/images/relics/feishu-cover.png",
    avatarUrl: "/images/relics/feishu-avatar.png",
    dialogs: [
