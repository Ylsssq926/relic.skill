...
Он может пробудить из разрозненных осколков данных интерактивную цифровую душу для всего, что вам дорого: человека, кота, отношений, команды, места, момента.
...
```text
"Помоги мне пробудить Relic. Я хочу сохранить бабушку."
...
```text
/relic              — Запускает процесс пробуждения Relic
/relic-forge        — Сразу переносит в Soul Awakener
...
│
├── soul-forge/                 # 🔥 Soul Awakener — пробуждает души из данных
│   ├── SKILL.md
...
│   │   └── live-collector.md   #   Разговор в реальном времени (живое пробуждение)
│   └── references/
